...
with_node \
  ...
  --target "/Users/eunhwa/client/qua-app/ios/Pods/Target Support Files/Pods-quaapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/eunhwa/client/qua-app/ios/quaapp/quaapp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-web-browser"
